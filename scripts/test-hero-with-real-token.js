const testHeroAPIWithRealToken = async () => {
  try {
    ...
    if (loginResult.success && loginResult.token) {
      ...
      // Test GET to see if new image was added
      console.log('\n🔍 Testing GET /api/admin/hero-images to see new image...');
      ...
      console.log('Total images:', getResult.data?.heroImages?.length || 0);
